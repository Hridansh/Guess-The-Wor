...
function send(){
    ...
    middle_no = Math.floor(word.length/2);
    chartAt2 = word.charAt(middle_no);
    last_no = word.length - 1;
    chartAt3 = word.charAt(last_no);

    replace1 = word.replace(chartAt1, "_")
    replace2 = replace1.replace(chartAt2, "_")
    replace3 = replace2.replace(chartAt3, "_")
